...
class ListingResource extends Resource
{
    ...
    // function form ini berlaku untuk create dan update
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('price_per_day')
                    ...
                    ->numeric()
                    ->default(0),
                Forms\Components\Checkbox::make('full-support_available')
                    ->default(0),
                Forms\Components\Checkbox::make('gym-area_available')
                    ->default(0),
